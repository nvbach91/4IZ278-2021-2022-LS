...
class Product
{
    ...
    public static function getImage($id)
    {
		...
		$externalPath = 'https://eso.vse.cz/~vase03/sp/upload/images/products/';
        $internalPath = '/home/httpd/html/users/vase03/sp/upload/images/products/';

        $pathToProductImage = $id . '.jpg';

        if (file_exists($internalPath . $pathToProductImage)) {
            return $externalPath . $pathToProductImage;
        }

        return $externalPath . $noImage;
    }
}
