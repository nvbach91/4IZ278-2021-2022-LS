...
<?php
    ...
    if (!count($errors)) {
        ...
        $userRecord = implode(';', [$name, $gender, $email, $phone, $avatar, $password]);
        //echo $userRecord;
...
<main>
    ...
    <div class="registration">
        <form class="reg-form" action="." method="POST">
            ...
            <div class="panes pane-password">
                <label for="avatar">*Password - 6 chars</label><br>
                <input value="<?php echo isset($password) ? $password : '' ?>" name="password" required> <!-- type="password"-->
            </div>
