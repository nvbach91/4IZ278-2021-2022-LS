        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (isset($_COOKIE['email'])): ?>
                    ...
                    <?php
                    if (isset($_SESSION) && $_SESSION["privilege"] == "3") {
                        ?>
                    ...
                    ?>
                    <li class="nav-item<?php echo strpos($_SERVER['REQUEST_URI'], 'world-clock') ? ' active' : '' ?>">
                        <a class="nav-link" href="world-clock.php">Clock</a>
                    </li>
                    <li class="nav-item<?php echo strpos($_SERVER['REQUEST_URI'], 'profile') ? ' active' : '' ?>">
                        <a class="nav-link" href="profile.php"><i
                                    class="fas fa-user"></i> <?php echo $_COOKIE['email']; ?></a>
                    </li>
                    <li class="nav-item">
