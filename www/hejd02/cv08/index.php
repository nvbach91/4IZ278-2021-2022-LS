...
<?php include __DIR__ . '/includes/navbar.php'; ?>
    ...
    <main class="container">
        ...
        <br><br>
<?php if (isset($_SESSION) && $_SESSION['privilege'] != 1): ?>
...
<?php endif ?>
        ...
        <div class="pagination">
            <?php for ($i = 1; $i <= ceil($count / $nItemsPerPagination); $i++) { ?>
                <a class="<?php echo $offset / $nItemsPerPagination + 1 == $i ? "active" : ""; ?>"
                   href="./index.php?offset=<?php echo ($i - 1) * $nItemsPerPagination; ?>">
                    <?php echo $i; ?>
                </a>
            <?php } ?>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text"><?php echo $row['description'] ?></div>
                                <div class="card-controls">
                                    ...
                                    <?php if (isset($_SESSION) && $_SESSION['privilege'] != 1): ?>
                                        <a class="btn btn-secondary card-link"
                                       href='./edit-item.php?id=<?php echo $row['id'] ?>'>Edit</a>
                                        <a class="btn btn-secondary card-link"
                                       href='./delete-item.php?id=<?php echo $row['id'] ?>'>Delete</a>
                                    <?php endif ?>
                                </div>
                        </div>
                    </div>
