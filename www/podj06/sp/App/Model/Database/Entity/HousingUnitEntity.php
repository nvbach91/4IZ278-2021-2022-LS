...
class HousingUnitEntity extends AbstractEntity
{
	...
	/**
	 * @var Collection<int, ExternalMeasurementEntity>
     * @ORM\OrderBy({"measuredAt" = "DESC"})
	 * @ORM\OneToMany(targetEntity="ExternalMeasurementEntity", mappedBy="housingUnit", cascade={"persist", "remove"})
	 */
	private Collection $externalMeasurements;
	...
	/**
	 * @return Collection<int, ExternalMeasurementEntity>
	 */
	public function getExternalMeasurements(): Collection
	{
