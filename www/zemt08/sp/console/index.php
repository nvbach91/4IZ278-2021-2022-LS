...
$data = $articles->getUserArticles($_SESSION['user_id'], $itemsPerPage, $offset);
$count = $articles->getUserArticlesCount($_SESSION['user_id'], $itemsPerPage, $offset);
?>
<!DOCTYPE html>
<html>
