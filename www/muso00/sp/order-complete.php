...
<div class="container w-25 mt-5">
    <div class="row text-center"><h1>Thank you for your purchase!</h1></div>
    <div class="row text-secondary fs-6"><p class="text-center">We are now preparing your order. The summary was sent to your email address.</p></div>
