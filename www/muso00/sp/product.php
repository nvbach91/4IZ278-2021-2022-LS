...
if (!empty($_GET)) {
    ...
    exit('<div class="alert alert-warning text-center" role="alert">You have not chosen a product. 
    <a href="./products.php" class="stretched-link link-warning">Start shopping</a></div>');
}

if (!empty($_POST)) {
    $qty = $_POST['qty'];
    require __DIR__ . '/utils/cart_items.php';
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="row mt-5 mb-4">
                    ...
                    <div class="col text-center"><span class="bold">Country:</span> <?php echo $product['origin']; ?></div>
                    <div class="col"><span class="bold">Bottle size:</span> <?php echo $product['bottle_size']; ?></div>
                </div>
                <div class="row mb-4">
                ...
                <div class="row text-end">
                    <form method="POST">
                        <div class="row">
                            ...
                            <div class="col">
                                <input class="align-items-end" type="number" name="qty" min="1" max="<?php echo $stock; ?>" value="1" <?php echo $stock == 0 ? 'disabled' : ''; ?>>
